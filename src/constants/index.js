...
export const RECEIVE_OPEN_INVOICES_DATA = 'RECEIVE_OPEN_INVOICES_DATA';

//Pending Invoices
export const RECEIVE_PENDING_INVOICE_DATA = 'RECEIVE_PENDING_WO_DATA';

//Awaiting Inovoices
export const RECEIVE_AWAITING_INVOICE_DATA = 'RECEIVE_AWAITING_INVOICE_DATA';

//Details WorkOrders and Invoices
export const RECEIVE_DETAILS_WO_DATA = 'RECEIVE_DETAILS_WO_DATA';
export const RECEIVE_DETAILS_INVOICE_DATA = 'RECEIVE_DETAILS_INVOICE_DATA';
...
export const RECEIVE_ASSIGNED_TO_ME_INVOICE_DATA = 'RECEIVE_ASSIGNED_TO_ME_INVOICE_DATA';
...
export const RECEIVE_ATTACHMENTS_INVOICE_DATA = 'RECEIVE_ATTACHMENTS_INVOICE_DATA';
...
export const RECEIVE_IS_ACCESSIBLE = 'RECEIVE_IS_ACCESSIBLE';
