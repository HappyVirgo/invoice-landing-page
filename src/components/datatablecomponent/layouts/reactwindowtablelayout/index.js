        ...
        <Table className={classes.table} component="div">
            ...
            <TableBody component="div" className={classes.tbody}>
            {
                firstLoading?(
                    ...
                    ):(<div style={{margin: '20px', display: 'flex', justifyContent: 'center'}}>No Available Data</div>)):(<div style={{margin: '20px', display: 'flex', justifyContent: 'center'}}>No Available Data</div>))
            }
            </TableBody>
        </Table>
        </div>
