...
const FilteringComponent = ({tmpdata, targetdata}) => {
    ...
    let data = tmpdata!==undefined?(tmpdata['data']?tmpdata['data']['invoices']:[]):[]
    ...
    // const disabledSelectAssetType = true
    const disabledSelectAssetType = false
    // let target = targetdata===undefined?"openIV":targetdata
    // let disabledSelectStatus = target==="pendingWO"?true:false
    // let disabledSelectPriority = target==="openIV"?true:false
    let disabledSelectStatus = false
