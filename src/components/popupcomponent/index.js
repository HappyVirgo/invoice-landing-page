...
export default function PopupComponent({ preConfirmationSubmit = null, buttonLabel, status, modalTitle, btnClasses, btnStartIcon, content, btn1Label="Yes", btn2Label="No", onSubmit, onCancel, submitDisabled = false, actionDisabled = true,  btn1Classes, btn2Classes, reassignToVal="" }) {
